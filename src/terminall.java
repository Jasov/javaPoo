...
public class terminall extends JFrame {
    ...
    public terminall() {
        ...
        JTextArea greetingArea = new JTextArea("¡Bienvenido a la terminal HeroXTerminal!\n\n ¡SHHH no se lo digas a nadie...aquí tienes una pequeña chuleta de nuestros comandos!\n Comandos:\n   hola caracola\n   pintar\n   tematica\n   personalizar\n   fiesta");
        greetingArea.setEditable(false);
        greetingArea.setBackground(Color.BLACK);
        greetingArea.setForeground(Color.CYAN);
        greetingArea.setFont(new Font("Monospaced", Font.PLAIN, 14));
            ...
            case "tematica" :
                ...
                switch (opcion) {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                    	setTerminalAndLeftPanelColors(Color.BLUE, Color.RED);
                    	break;
                    case "5":
                    	setTerminalAndLeftPanelColors(Color.RED, Color.YELLOW);
                    	break;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new terminall());
    }
}